...
export default function Navbar() {
  return (
    <header className="fixed left-0 right-0 top-0 z-50 mx-auto mt-6 flex w-[95%] max-w-7xl items-center justify-between rounded-full border border-cyan-400/20 bg-slate-950/60 px-8 py-3 shadow-[0_0_40px_rgba(0,229,255,0.06)] backdrop-blur-xl">
      <a href="#" className="flex shrink-0 items-center gap-3" aria-label="P2A Tech — início">
        <img
          alt="P2A Tech"
      ...
      <nav className="hidden items-center gap-8 md:flex">
        <a className={navLinkActive} href="#">
          SOLUÇÕES
        </a>
      ...
      <div className="flex items-center gap-4">
        <button
          type="button"
          className="rounded-full bg-primary-container px-4 py-2 font-label text-[10px] font-bold uppercase tracking-widest text-on-primary-container transition-all hover:brightness-110 active:scale-95 sm:px-6"
        >
          DIAGNÓSTICO IA
        </button>
      </div>
